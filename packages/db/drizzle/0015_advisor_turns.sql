CREATE TABLE `advisor_turns` (
	...
	CONSTRAINT "advisor_turn_abstained" CHECK(("advisor_turns"."status" = 'succeeded' and "advisor_turns"."abstained" in (0, 1)) or ("advisor_turns"."status" <> 'succeeded' and "advisor_turns"."abstained" is null)),
